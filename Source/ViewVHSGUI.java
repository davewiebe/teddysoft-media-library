...
public class ViewVHSGUI implements ActionListener{
	...
	private Component mainWindowComponents() {
		...
		JLabel rated = new JLabel(vhs.getContentRated());
